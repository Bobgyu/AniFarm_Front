        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="appearance-none relative block w-full px-4 py-3 border border-[#8bd05c] placeholder-[#8bd05c]/40 text-gray-900 font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8bd05c] focus:border-transparent transition-all duration-200 ease-in-out hover:border-[#8bd05c]"
                name="password">
                <DatePicker
                  ref={datePickerRef}
                  selected={startDate}
                  onChange={(date) => {
                    setStartDate(date);
                    setValue({ ...value, birth_date: date.toISOString().split('T')[0] });
                  }}
